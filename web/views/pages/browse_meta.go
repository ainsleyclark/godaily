...
var tagTitles = map[news.Tag]string{
	...
	news.TagProposalAccepted: "<span class=\"listing-hero__accent\">Accepted</span> Go proposals.",
...
var tagSubs = map[news.Tag]string{
	...
	news.TagProposalAccepted: "Go proposals that have been accepted and are headed for a future release.",
...
var tagDescs = map[news.Tag]string{
	...
	news.TagProposalAccepted: "Go proposals accepted by the proposal review committee — new language features, standard library additions, and toolchain changes headed for a future release.",
