...
// Source: github.com/ainsleyclark/godaily/pkg/gateway/social (interfaces: Poster)
//
// Generated by this command:
//
//	mockgen -package=mocksocial -destination=../../mocks/social/Poster.go github.com/ainsleyclark/godaily/pkg/gateway/social Poster
//
...
func (m *MockPoster) Post(ctx context.Context, text string) (social.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Post", ctx, text)
	ret0, _ := ret[0].(social.Result)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
