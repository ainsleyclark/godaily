...
// Source: github.com/ainsleyclark/godaily/pkg/domain/audience (interfaces: SubscriberRepository)
//
// Generated by this command:
//
//	mockgen -package=mockaudience -destination=../../mocks/audience/SubscriberRepository.go . SubscriberRepository
//
...
func (m *MockSubscriberRepository) Confirm(ctx context.Context, token string) (audience.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) Find(ctx context.Context, id int64) (audience.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) FindByEmail(ctx context.Context, email string) (audience.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) FindByUnsubscribeToken(ctx context.Context, token string) (audience.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) List(ctx context.Context, opts store.ListOptions) ([]audience.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) ListActive(ctx context.Context) ([]audience.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) Reactivate(ctx context.Context, email string) (audience.Subscriber, error) {
	m.ctrl.T.Helper()
