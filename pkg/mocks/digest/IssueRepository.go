...
// Source: github.com/ainsleyclark/godaily/pkg/domain/digest (interfaces: IssueRepository)
//
// Generated by this command:
//
//	mockgen -package=mockdigest -destination=../../mocks/digest/IssueRepository.go . IssueRepository
//
...
func (m *MockIssueRepository) Create(ctx context.Context, issue digest.Issue) (digest.Issue, error) {
	m.ctrl.T.Helper()
...
func (m *MockIssueRepository) Delete(ctx context.Context, id int64) (digest.Issue, error) {
	m.ctrl.T.Helper()
...
func (m *MockIssueRepository) Find(ctx context.Context, id int64) (digest.Issue, error) {
	m.ctrl.T.Helper()
...
func (m *MockIssueRepository) FindBySlug(ctx context.Context, slug string) (digest.Issue, error) {
	m.ctrl.T.Helper()
...
func (m *MockIssueRepository) Latest(ctx context.Context, limit int) ([]digest.Issue, error) {
	m.ctrl.T.Helper()
