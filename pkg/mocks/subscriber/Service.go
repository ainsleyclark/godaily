...
// Source: github.com/ainsleyclark/godaily/pkg/domain/subscriber (interfaces: Service)
//
// Generated by this command:
//
//	mockgen -package=mocksubscriber -destination=../../mocks/subscriber/Service.go . Service
//
...
func (m *MockService) Subscribe(ctx context.Context, email string) (subscriber.Subscriber, error) {
	m.ctrl.T.Helper()
