...
// Source: github.com/ainsleyclark/godaily/pkg/domain/news (interfaces: IssueRepository)
//
// Generated by this command:
//
//	mockgen -package=mocknews -destination=../../mocks/domain/news/IssueRepository.go . IssueRepository
//
...
func (m *MockIssueRepository) Delete(ctx context.Context, id int64) (news.Issue, error) {
	m.ctrl.T.Helper()
