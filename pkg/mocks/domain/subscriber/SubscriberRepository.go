...
// Source: github.com/ainsleyclark/godaily/pkg/domain/subscriber (interfaces: SubscriberRepository)
//
// Generated by this command:
//
//	mockgen -package=mocksubscriberdomain -destination=../../../mocks/domain/subscriber/SubscriberRepository.go . SubscriberRepository
//

// Package mocksubscriberdomain is a generated GoMock package.
package mocksubscriberdomain
...
func (m *MockSubscriberRepository) Confirm(ctx context.Context, token string) (subscriber.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) Create(ctx context.Context, email string) (subscriber.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) Find(ctx context.Context, id int64) (subscriber.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) FindByEmail(ctx context.Context, email string) (subscriber.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) FindByUnsubscribeToken(ctx context.Context, token string) (subscriber.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) ListActive(ctx context.Context) ([]subscriber.Subscriber, error) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriberRepository) Reactivate(ctx context.Context, email string) (subscriber.Subscriber, error) {
	m.ctrl.T.Helper()
